...
export default function SkincareDetail() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const result = await skincareAPI.fetchById(id);
  ...
  if (!product) {
    return <div className="p-6 text-red-500">Produk skincare tidak ditemukan.</div>;
  }
  ...
  return (
    <div className="max-w-7xl mx-auto px-6 py-10 grid md:grid-cols-2 gap-10">
      ...
      <div className="space-y-4">
        ...
        <p className="text-sm text-gray-500">BPOM: {product.sku}</p>
